...
export default function PromotionBanner() {
  return (
    <section className="relative w-full border-t border-gray-200 py-4 md:py-6 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#00A86B]/10 via-[#00BF72]/10 to-[#007F5F]/10 z-0"></div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            ...
            <p className="text-base text-gray-600 max-w-md">
              Hire expert developers at Emergent App Builders to build, manage and scale your software pipeline.
            </p>
          ...
          <div className="w-full aspect-video md:aspect-none md:h-[280px] md:flex-1 relative mb-8 md:mb-0">
            <Image
              src="/team-photo.webp"
              alt="Emergent App Builders Team"
              fill
