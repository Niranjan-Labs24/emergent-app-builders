    ...
    <footer className="py-6 md:py-8 border-t border-gray-100 bg-white">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-base md:text-lg text-gray-500 font-medium">© {new Date().getFullYear()} Cursor Coder. All rights reserved.</p>
          ...
          <div className="flex items-center gap-6 justify-end flex-1">
            ...
            <Link href="https://linkedin.com/company/cursor-coder" target="_blank" className="p-2 text-gray-500 hover:text-black transition-colors transform hover:scale-110">
              <Linkedin className="h-5 w-5 md:h-6 md:w-6" />
            </Link>
            <Link href="https://x.com/cursorcoder" target="_blank" className="p-2 text-gray-500 hover:text-black transition-colors transform hover:scale-110">
