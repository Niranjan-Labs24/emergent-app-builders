...
export const benefitItems: BenefitItem[] = [
  {
    package: 'STARTER',
    labels: [
      'Direct access to Emergent AI experts',
  ...
  },
  {
    ...
    labels: [
      ...
      'Dedicated development team (2-3 Emergent experts)',
...
export const pricingFAQs: FAQItem[] = [
  {
    question: "What kinds of apps can you build with Emergent?",
    answer: "We build SaaS platforms, MVPs, web apps, customer portals, internal tools, e-commerce stores, AI-powered products, dashboards, booking systems, marketplace apps, and landing pages — all using Emergent.sh as the primary build tool. If it can be described in plain English and runs in a browser, we can build it with Emergent."
  },
  {
  ...
  {
    question: "Can you rescue or fix my existing Emergent project?",
    answer: "Yes — this is one of our most popular services. Whether your Emergent app is stuck in a loop, has broken Supabase connections, security vulnerabilities, or simply isn't doing what you need, we diagnose and fix the issue efficiently."
  },
  {
    question: "How much does it cost to build an Emergent app?",
    answer: "Our pricing is flexible and transparent. You can choose from hourly blocks for small tasks, or volume packages for larger projects. We handle all Emergent platform credits and subscriptions, so you never have to worry about surprise costs."
  }
];
